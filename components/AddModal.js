    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
          <div>
            <h2 style={{ fontSize: 16, fontWeight: 700, marginBottom: 2 }}>Add Application</h2>
            <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)' }}>Track a new job opportunity</p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 14, marginBottom: 14 }}>
            <div>
              ...
              <input required value={form.company} onChange={e => set('company', e.target.value)}
                style={inputStyle} placeholder="Stripe" />
            </div>
            <div>
              <label style={labelStyle}>ROLE *</label>
              <input required value={form.role} onChange={e => set('role', e.target.value)}
                style={inputStyle} placeholder="Frontend Engineer" />
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 14, marginBottom: 14 }}>
            <div>
              ...
              <input value={form.location} onChange={e => set('location', e.target.value)}
                style={inputStyle} placeholder="Remote" />
            </div>
            <div>
              <label style={labelStyle}>SALARY</label>
              <input value={form.salary} onChange={e => set('salary', e.target.value)}
                style={inputStyle} placeholder="$120k–140k" />
            </div>
          </div>
